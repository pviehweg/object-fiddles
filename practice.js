...
var favoriteThings = {band: 'Fall Out Boy', food: 'Most All', person: "Tye", book: 'The Host', movie: 'Pride and Prejudice', holiday: 'Christmas'}
...
var alsoMe = {name: 'Paige', age: '29', height: 'five seve', gender: "Girl yo", married: 'you know it', eyeColor: 'cow crap brown', hairColor: 'brown'}

//Now, loop through your object and alert every value. *Tyler --> 24 --> 6'0 --> Male, etc etc


for (var name in alsoMe) {
  alert(alsoMe[name]);
}
...
var album = {song1: 234, song2: 2343, song3: 098, song4: 9082, song5: 9023};
...
var states = {utah: 23432, florida: 234324, ohio: 2342334, idaho: 9080, montana: 12}

//Now, loop through your states object and if the states population is greater than 30K, alert that state.

// var popAlert = function(states) {
